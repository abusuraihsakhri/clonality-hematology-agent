"""
FastAPI REST Application & Webhooks for ClonoMind: IGH & TCR Gene Rearrangement Clonality Distributed Component Classifier.
"""
...
def create_app():
    try:
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "clonality-hematology-agent", "domain": "Hematopathology", "version": "2.0.0-PRO"}
