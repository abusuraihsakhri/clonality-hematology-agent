"""
Command-Line Interface for ClonoMind: IGH & TCR Gene Rearrangement Clonality Distributed Component Classifier.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Hematopathology | Standard: WHO 5th Edition / ICC Hematolymphoid 2022")
